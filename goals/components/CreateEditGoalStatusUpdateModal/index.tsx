...
import GoalTargetValueMessage from '../Shared/TargetValue/GoalTargetValueMessage';
import StatusUpdateSelectors from './StatusUpdateSelectors';
  ...
  const handleAchievedChanged = useCallback((value: string): void => {
    ...
    formContext.setValue(
      ...
      value === String(AchievedNotToggle.Achieved)
        ? AchievedNotToggle.Achieved as boolean
        : AchievedNotToggle.NotAchieved as boolean,
    );
  }, [formContext]);
